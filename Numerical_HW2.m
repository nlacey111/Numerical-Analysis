...
plot([0,rightsingular(1,1)],[0, rightsingular(2,1)])
plot([0,rightsingular(1,2)],[0, rightsingular(2,2)])

labels = {'v1','v2'};
plot([rightsingular(1,1), rightsingular(1,2)],[rightsingular(2,1), rightsingular(2,2)],'o')
text([rightsingular(1,1), rightsingular(1,2)],[rightsingular(2,1), rightsingular(2,2)],labels,'VerticalAlignment','bottom','HorizontalAlignment','right')
